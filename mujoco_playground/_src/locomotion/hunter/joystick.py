...
class Joystick(hunter_base.HunterEnv):
  ...
  def _post_init(self):
    ...
    # Set joint limits
    print("self.mj_model.jnt_range", self.mj_model.jnt_range, "shape", self.mj_model.jnt_range.shape)
  ...
  def reset(self, rng: Optional[Union[int, jp.ndarray]] = None):
    ...
    print("qpos", qpos, "shape", qpos.shape)
    print("qvel", qvel, "shape", qvel.shape)
