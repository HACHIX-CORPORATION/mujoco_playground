...
class Joystick(hunter_base.HunterEnv):
    ...
    def _post_init(self) -> None:
        ...
        self._hip_indices = jp.array(consts.HIP_INDICIES)
        self._knee_indices = jp.array(consts.KNEE_INDICIES)
        self._ankle_indices = jp.array(consts.ANKLE_INDICIES)
    ...
    def reset(self, rng: jax.Array) -> mjx_env.State:
        ...
        push_interval_steps = jp.round(push_interval / self.dt).astype(
            jp.int32
        )
